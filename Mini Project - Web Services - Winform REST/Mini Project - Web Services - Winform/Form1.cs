...
namespace Mini_Project___Web_Services___Winform
{
    ...
    {
        Mini_Project___Web_Services___REST.Controllers.smoothieController Service = new Mini_Project___Web_Services___REST.Controllers.smoothieController();
